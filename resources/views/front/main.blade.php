    ...
    <div class="container">
        <div class="jumbotron d-flex align-items-center bg-transparent text-white" data-aos="fade-up" data-aos-delay="150" data-aos-easing="ease-in-out-cubic">
            <div class="container">
                ...
                <img src="https://kingsgaming.us/img/logo-full.svg" class="w-25 h-auto mx-auto justify-content-center d-flex flex-column pt-3 pb-3" data-aos="fade-in" data-aos-delay="250" data-aos-easing="ease-in-out-cubic">
        ...
        <div class="row">
            <div class="card-deck mx-auto">
                    <div class="card bg-dark text-white mb-5 h-auto w-65 mx-2 border-0"  data-aos="fade-up" data-aos-delay="150" data-aos-easing="ease-in-out-cubic">
                        <img class="card-img" src="https://kingsgaming.us/img/backgrounds/discord.png" alt="Card image">
                        <div class="card-img-overlay h-100 d-flex flex-column justify-content-center">
                            ...
                            <a href="{{route('discord')}}" class="btn btn-outline-light justify-content-end mt-auto">Join our Discord!</a>
                        </div>
                    </div>
                    <div class="card bg-dark text-white mb-5 h-auto w-65  mx-2 border-0"  data-aos="fade-up" data-aos-delay="350" data-aos-easing="ease-in-out-cubic">
                        <img class="card-img" src="https://kingsgaming.us/img/backgrounds/server.jpg"  alt="Card image" >
                        <div class="card-img-overlay h-100 d-flex flex-column justify-content-center" style="background: rgba(5,5,5,0.8);">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated @if($calc <= 25) bg-success @elseif($calc >= 50) bg-warning @elseif($calc >= 75) bg-danger @else bg-success @endif" style="width: {{$calc}}%" role="progressbar" aria-valuenow="{{$serverInfo['Players']}}" aria-valuemin="0" aria-valuemax="{{$serverInfo['MaxPlayers']}}"></div>
                            </div>
                            <p class="card-text text-center text-muted text-uppercase pt-2">{{$serverInfo['Players']}}/{{$serverInfo['MaxPlayers']}} Players Online</p>
                            <a href="{{route('server')}}" class="btn btn-outline-light justify-content-end mt-auto">Connect now!</a>
                        </div>
                    </div>
                    <div class="card bg-dark text-white mb-5 h-auto w-65  mx-2 border-0"  data-aos="fade-up" data-aos-delay="550" data-aos-easing="ease-in-out-cubic">
                        <img class="card-img" src="https://kingsgaming.us/img/backgrounds/group.jpg"  alt="Card image">
                        <div class="card-img-overlay h-100 d-flex flex-column justify-content-center" style="background: rgba(5,5,5,0.8);">
